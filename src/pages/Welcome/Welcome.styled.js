...
export const DogContainer = styled.div`display:flex;`;
export const HomeWrapper = styled.div`display:flex;`;
...
export const Position = styled(PageHeaderStyled)`
  ...
  .text {
    span {
      ...
      animation: ${textRotate1} 4.4s infinite alternate;
    }
    &.second {
      color: ${pink["50"]};
      position: absolute;
      ...
      span {
        transform-origin: bottom;
        transform: translate3d(0, 100%, 0) rotateX(-90deg);
        animation: ${textRotate2} 4.4s infinite alternate;
      }
    }
  }
  @media screen and (max-width: 1204px) {
